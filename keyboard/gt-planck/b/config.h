...
#define CONF_PRODUCT_ID 0x0323 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Glab" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "GT Planck_B" /* 硬件名词，用于蓝牙显示 */
...
// 旋钮配置
#define ROTARY_ENCODER_A 28
#define ROTARY_ENCODER_B 27
// 旋钮正向按钮映射
#define ROTARY_ENCODER_POS 4,0
// 旋钮负向按钮映射
#define ROTARY_ENCODER_NEG 4,1
// 独立旋钮按键  用于关机后开机
